...
extern MPI_Datatype vect_mpi_t; // Derived data type used
extern const double G;          // Gravitational constant
extern int my_rank, comm_sz;    // Process ID and total number of processes
extern vect_t *vel;             // Global speed, used for outputs of process 0
