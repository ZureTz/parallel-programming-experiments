...
inline void resetTimer(hwtimer_t *timer) { timer->start = timer->end = 0; }
...
inline void startTimer(hwtimer_t *timer) { timer->start = _rdtsc(); }

inline void stopTimer(hwtimer_t *timer) { timer->end = _rdtsc(); }
